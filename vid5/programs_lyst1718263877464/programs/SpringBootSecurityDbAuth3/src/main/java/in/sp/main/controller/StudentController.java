...
public class StudentController
{
	...
	@GetMapping("/profile")
	public String openProfilePage(Authentication authentication, Model model)
	{
		CustomStdDetails stdDetails = (CustomStdDetails) authentication.getPrincipal();
		
		model.addAttribute("stdName", stdDetails.getName());
